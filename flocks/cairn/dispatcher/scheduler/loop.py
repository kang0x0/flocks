...
from flocks.cairn.dispatcher.models import ReasonCheckpoint, RunningTask
...
from flocks.cairn.dispatcher.runtime.startup_healthcheck import format_failure_summary, run_startup_healthchecks
from flocks.cairn.dispatcher.scheduler.worker_select import choose_worker
from flocks.cairn.dispatcher.tasks.bootstrap import run_bootstrap_task
from flocks.cairn.dispatcher.tasks.explore import run_explore_task
from flocks.cairn.dispatcher.tasks.reason import run_reason_task
from flocks.cairn.models import Intent, ProjectDetail, ProjectSummary
...
class DispatcherLoop:
    ...
    def _queue_container_cleanups(self, summaries: list[ProjectSummary]) -> None:
        if self.container_manager.disabled:
            self._inactive_cleanup_done.clear()
